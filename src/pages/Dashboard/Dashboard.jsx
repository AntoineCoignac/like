                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="infos">
                        ...
                        <span className="info">
                          <TimeRemaining endTime={order.deadline} />
                        </span>
                        <span className="info">
                      ...
                      <p className="desc">
                        {order.sellerId === currentUser._id
                          ? `Vendu par vous à ${user.name}`
                          : `Vendu par ${seller.name} à vous`}
                      </p>
                      {order.acceptedBySeller === null ? (
                        ...
                        <div className="situation" id="ok">
                          ...
                          >
                            <path
                              d="M7.28828 0.815376L11.7903 3.99223C11.91 4.07671 11.9867 4.20945 12 4.35537L12.5002 9.84266C12.5194 10.0533 12.4039 10.2533 12.2119 10.342L7.20966 12.6524C7.07664 12.7138 6.92336 12.7138 6.79034 12.6524L1.7881 10.342C1.59606 10.2533 1.48062 10.0533 1.49982 9.84266L2.00004 4.35536C2.01335 4.20945 2.08998 4.07671 2.2097 3.99223L6.71172 0.815375C6.88456 0.693414 7.11544 0.693414 7.28828 0.815376Z"
                              stroke="#29B9F2"
                            />
                            <rect
                              x="4.42705"
                              ...
                              width="0.486236"
                              height="2.23073"
                              transform="rotate(-47.2528 4.42705 7.62125)"
                              fill="#29B9F2"
                              stroke="#29B9F2"
                              strokeWidth="0.486236"
                            />
                            <rect
                              x="6.0651"
                              y="9.13496"
                              width="0.486236"
                              height="5.16859"
                              transform="rotate(-137.253 6.0651 9.13496)"
                              fill="#29B9F2"
                              stroke="#29B9F2"
                              strokeWidth="0.486236"
                            />
