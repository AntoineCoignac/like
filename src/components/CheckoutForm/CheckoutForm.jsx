    ...
    const handleSubmit = async (e) => {
        ...
        const { error } = await stripe.confirmPayment({
            ...
            confirmParams: {
                ...
                return_url: `http://localhost:3000/success?brief=${brief}`,
            },
        });
        ...
        <>
            ...
            <div className="payment-ctn">
                ...
                <div className="brief">
                    ...
                    <textarea name="brief" id="" maxLength={1000} placeholder="Expliquez ce que vous voulez (au moins 20 caractères)" cols="30" rows="3" value={brief}
                        onChange={handleBriefChange}></textarea>
                    <span className="counter" id={brief.length >= 20 ? "valid" : null}>{brief.length}/1000</span>
                </div>
                {
                    brief.length >= 20 ? (
                        <>
                            <p className="big-title">Informations de paiement</p>
                            <form id="payment-form" onSubmit={handleSubmit}>
                                ...
                                <button className="payment-btn" disabled={isLoading || !stripe || !elements || brief.length < 20} id="submit">
                                    <span id="button-text">
